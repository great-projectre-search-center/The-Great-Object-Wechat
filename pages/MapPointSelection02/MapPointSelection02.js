...
Page({
  ...
  addMarker: function(data) {
    ...
    mks.push({ // 获取返回结果，放到mks数组中
      ...
      iconPath: "../../libs/imgs/postion.png", //图标路径
      width: 25,
      height: 25
    })
  ...
  selectedOk: function() {
    ...
    console.log(this.data.centerData)//打印所以信息，后期再调整     传参
    prevPage.setData({
      addresschoseId: this.data.centerData.latitude+","+this.data.centerData.longitude,
    })
    wx.navigateBack({
      delta: 1
    })
