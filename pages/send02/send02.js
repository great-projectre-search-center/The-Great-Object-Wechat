...
Page({
    ...
    data: {
      ...
      storeAddress:"",
      biaoti:"",
      arraycompany: ['高等数学', '离散数学', '概率论与数理统计', '数据结构','C语言','C++','Java','计算机组成原理','汇编语言'],
      index: 0,
      arrayvalue: ['限时10分钟', '限时15分钟', '限时20分钟', '限时25分钟', '限时30分钟', '限时35分钟', '限时40分钟','当天内送达即可'],
      value: 0,
      date: '2016-09-01',
      time: '12:01',
      openid:"",
    ...
    create:function(e){
      ...
      var order={
        ...
        accept_Date:"",   //为空
        public_field1:this.data.arraycompany[this.data.index],
